...
<p align="center"><img width='750' src='src/main/resources/icon.png'>
 ...
 Makes the colder biomes feel livelier with more items, effects, blocks and entities. This mod adds Arctic Cod, Harp Seals, Snow Globes, and more. It also adds the crate block, crafted with a chest, planks and iron, which can store a lot of one type of item or block, but it can't store anything else, making it an early game bulk storage option.

This mod is only out for Neoforge 1.21.1 currently. I also recommend using JEI/REI.

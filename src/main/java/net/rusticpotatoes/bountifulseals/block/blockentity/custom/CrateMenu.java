...
public class CrateMenu extends AbstractContainerMenu {
    ...
    public CrateMenu(int containerId, Inventory inv, BlockEntity blockEntity) {
       ...
       // this.addSlot(new FilterSlot(this.blockEntity.inventory, 0, 50, 50));
        ...
        this.addSlot(new FilterSlot(this.blockEntity, this.blockEntity.inventory, 67, 170, -15));
    ...
    private static final int TE_INVENTORY_SLOT_COUNT = 67;  // must be the number of slots you have!
    @Override

...
public class ModBlockLootTableProvider extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        dropSelf(ModBlocks.SUGAR_CRYSTAL_BLOCK.get());
        dropSelf(ModBlocks.SUGAR_CRYSTAL_STAIRS.get());
        add(ModBlocks.SUGAR_CRYSTAL_SLAB.get(),block -> createSlabItemTable(ModBlocks.SUGAR_CRYSTAL_SLAB.get()));
    }

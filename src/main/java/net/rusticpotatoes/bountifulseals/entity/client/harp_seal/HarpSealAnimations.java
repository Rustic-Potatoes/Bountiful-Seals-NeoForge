...
public class HarpSealAnimations {
    ...
    public static final AnimationDefinition WALK_ANIM = AnimationDefinition.Builder.withLength(1.0F).looping()
            ...
            .addAnimation("leftleg", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    ...
                    new Keyframe(0.3333F, KeyframeAnimations.degreeVec(0.0F, -7.5F, 5.0F), AnimationChannel.Interpolations.CATMULLROM),
    ...
    public static final AnimationDefinition IDLE_ANIM = AnimationDefinition.Builder.withLength(4.0F).looping()
        ...
        public static final AnimationDefinition BOOP_ANIM = AnimationDefinition.Builder.withLength(1.5F)
                .addAnimation("main", new AnimationChannel(AnimationChannel.Targets.SCALE,
                        ...
                        new Keyframe(0.3333F, KeyframeAnimations.scaleVec(0.95F, 1.0F, 1.0F), AnimationChannel.Interpolations.LINEAR),
                ...
                .addAnimation("head", new AnimationChannel(AnimationChannel.Targets.POSITION,
                        ...
                        new Keyframe(0.2917F, KeyframeAnimations.posVec(2.5F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
                        new Keyframe(1.2917F, KeyframeAnimations.posVec(2.5F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
                        new Keyframe(1.5F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR)
                ))
                .addAnimation("legs", new AnimationChannel(AnimationChannel.Targets.POSITION,
                        new Keyframe(0.1667F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
                        new Keyframe(0.375F, KeyframeAnimations.posVec(-0.5F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
                ...
                .addAnimation("eyes", new AnimationChannel(AnimationChannel.Targets.SCALE,
                        ...
                        new Keyframe(1.25F, KeyframeAnimations.scaleVec(1.0F, 0.1F, 1.0F), AnimationChannel.Interpolations.CATMULLROM),
                        new Keyframe(1.2917F, KeyframeAnimations.scaleVec(1.0F, 1.0F, 1.0F), AnimationChannel.Interpolations.CATMULLROM)
                ))
                .build();

    public static final AnimationDefinition CHILD_WALK_ANIM = AnimationDefinition.Builder.withLength(1.0F).looping()
            .addAnimation("main", new AnimationChannel(AnimationChannel.Targets.POSITION,
                    new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
                    new Keyframe(0.2917F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
            ...
            .addAnimation("head", new AnimationChannel(AnimationChannel.Targets.POSITION,
                    ...
                    new Keyframe(0.5F, KeyframeAnimations.posVec(0.0F, -0.25F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
                    new Keyframe(0.75F, KeyframeAnimations.posVec(-0.125F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
                    new Keyframe(1.0F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM)
            ))
            .addAnimation("lowerhalf", new AnimationChannel(AnimationChannel.Targets.POSITION,
                    new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
                    new Keyframe(0.375F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
                    new Keyframe(0.7083F, KeyframeAnimations.posVec(0.25F, -0.125F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
                    new Keyframe(1.0F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM)
            ))
            .addAnimation("legs", new AnimationChannel(AnimationChannel.Targets.POSITION,
                    new Keyframe(0.375F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
    ...
    public static final AnimationDefinition CHILD_IDLE_ANIM = AnimationDefinition.Builder.withLength(4.0F).looping()
            .addAnimation("nose", new AnimationChannel(AnimationChannel.Targets.POSITION,
                    new Keyframe(2.2917F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
                    new Keyframe(2.4583F, KeyframeAnimations.posVec(0.125F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
            ...
            .addAnimation("eyes", new AnimationChannel(AnimationChannel.Targets.SCALE,
                    ...
                    new Keyframe(0.875F, KeyframeAnimations.scaleVec(1.0F, 0.05F, 1.0F), AnimationChannel.Interpolations.CATMULLROM),
